...
[+]GitHub  : https://github.com/RisingLamp[+]""")
    ...
    def track():
        ...
        if tip == "help":
            ...
            print(
                Fore.YELLOW + "Thanks for using my tool\nIf you find any error,donot hestitate to message me on rising.teachntech@gmail.com")
            exit()
        elif tip == "iptracker":
            print(Fore.GREEN + """__________________________Track Ip with Rising________________""")
            print("""
            """)
